...
export const typedData:ResumeData = {
    ...
    references: {
        showDetail: false,
        references: [
            {name: "Steve Ballmer", careerTitle: "Sales", contacts:[], companyName: "Microsoft Developers"},
            {name: "Stephen Jobs", careerTitle: "Office Partner", contacts:[], companyName: "Apple Seed"},
        ]
    }
